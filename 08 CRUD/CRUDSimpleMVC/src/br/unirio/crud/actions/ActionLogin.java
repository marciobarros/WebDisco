...
public class ActionLogin extends Action
{
	...
	public String login() throws ActionException
	{
		...
		check(!usuario.isDeveTrocarSenha(), "O sistema indica que você precisa fazer um reset de senha. Isto pode ter ocorrido porque você pediu o reset e ainda não recebemos a confirmação ou porque houve três tentativas mal-sucedidas de acesso à sua conta. Se necessário, clique na opção \"Esqueceu sua senha?\" para enviarmos novamente o e-mail de reset de senha.");
	...
	/**
	 * Prepara o formulário de envio de token por esquecimento de senha
	 */
	@DisableUserVerification
	@Error("/login/login.do")
	...
	/**
	 * Ação de envio de token por esquecimento de senha
	 */
	@DisableUserVerification
...
//		return addRedirectNotice("pedido.reinicializacao.email");
	...
	/**
	 * Ação que recebe e verifica a validade do token de troca de senha
	 */
	@DisableUserVerification
	@Error("/login/login.do")
	...
	/**
	 * Ação que salva os dados de um novo usuário
	 */
	@DisableUserVerification
	@Success(type=ResultType.Redirect, value="/login/login.do")
