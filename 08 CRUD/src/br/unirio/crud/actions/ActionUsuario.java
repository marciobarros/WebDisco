...
/**
 * Acoes relacionadas a manutencao dos usuários
 * 
...
{
	/**
	 * Acao que apresenta a pagina principal de manutencao dos usuários
	 */
	...
	/**
	 * Acao para criar um novo usuário
	 */
	...
	public String edita() throws ActionException
	{
		...
		check(usuario != null, "O usuário selecionado nao foi encontrado no sistema.");
		setAttribute("usuario", usuario);
	...
	/**
	 * Acao para salvar os dados de um usuário 
	 */
	...
	/**
	 * Acao AJAX para remover um usuário
	 */
	@Ajax
