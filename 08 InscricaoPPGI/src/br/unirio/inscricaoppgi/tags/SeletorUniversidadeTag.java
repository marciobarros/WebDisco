...
public class SeletorUniversidadeTag extends TagSupport
{
	...
	public int doStartTag() throws JspException
	{
		...
		try
		{
			...
			for (Universidade universidade : Universidade.values())
			{
				String codigo = universidade.getCodigo();
				String nome = universidade.getNome();
				String selecionado = (valor.compareToIgnoreCase(codigo) == 0) ? " SELECTED" : "";
				out.write("<option value='" + codigo + "'" + selecionado + ">" + StringEscapeUtils.escapeHtml4(nome) + "</option>\n");
			}
