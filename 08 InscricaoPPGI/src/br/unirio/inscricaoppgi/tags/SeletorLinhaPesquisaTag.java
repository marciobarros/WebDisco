...
public class SeletorLinhaPesquisaTag extends TagSupport
{
	...
	public SeletorLinhaPesquisaTag()
	{
		this.id = "";
		this.nome = "";
		this.valor = "";
	...
	public int doStartTag() throws JspException
	{
		...
		try
		{
			...
			for (LinhaPesquisa linha : LinhaPesquisa.values())
			{
				String selecionado = (linha.getCodigo().compareToIgnoreCase(valor) == 0) ? " SELECTED" : "";
				out.write("<option value='" + linha.getCodigo() + "'" + selecionado + ">" + StringEscapeUtils.escapeHtml4(linha.getNome()) + "</option>\n");
			}
