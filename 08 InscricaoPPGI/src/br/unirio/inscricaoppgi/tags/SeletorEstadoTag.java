...
import br.unirio.inscricaoppgi.config.ControladorEstados;
...
public class SeletorEstadoTag extends TagSupport
{
	...
	public int doStartTag() throws JspException
	{
		...
		try
		{
			...
			for (String sigla : ControladorEstados.getSiglas())
			{
				String nome = ControladorEstados.getNome(sigla);
				String selecionado = (valor.compareToIgnoreCase(sigla) == 0) ? " SELECTED" : "";
				out.write("<option value='" + sigla + "'" + selecionado + ">" + StringEscapeUtils.escapeHtml4(nome) + "</option>\n");
			}
