...
public class MailSender implements IMailSender
{
	...
	/**
	 * Server port to send e-mails 
	 */
	private int hostPort;
	
	/**
	 * User to log in the e-mail server
	 */
	private String hostUser;

	/**
	 * Password to log in the e-mail server
	 */
	private String hostPassword;
	
	/**
	 * Current session for creating multi-part messages
	 */
	private Session mailSession;
	
	/**
	 * Current connection to the transport layer 
	 */
	...
	public boolean open()
	{
		try
		{
			...
			this.transport.connect(hostName, hostPort, hostUser, hostPassword);
	...
	{
		boolean transportOpened = (transport != null);
